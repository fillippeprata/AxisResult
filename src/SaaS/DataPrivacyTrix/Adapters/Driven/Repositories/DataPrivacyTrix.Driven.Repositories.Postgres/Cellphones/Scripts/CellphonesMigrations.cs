...
internal static class CellphonesMigrations
{
    private const string MigrationsTable = $"{CellphonesDbInit.Schema}.SCHEMA_MIGRATIONS";
    ...
    public static async Task InitializePostgresAsync(string connectionString)
    {
        ...
        await using (var cmd = new NpgsqlCommand(
                         $"CREATE SCHEMA IF NOT EXISTS {CellphonesDbInit.Schema};" +
        ...
        foreach (var (version, script) in CellphonesDbInit.Migrations)
        {
