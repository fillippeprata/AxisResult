...
namespace DataPrivacyTrix.UnitTests.Application.AxisIdentity.v1;
...
public class ValidationTests
{
    ...
    public async Task RegisterByCellphoneShouldFailWhenDataIsNullAsync()
    {
        ...
        var result = await AxisIdentitiesMediator(scope).RegisterByCellphoneAsync(command);
    ...
    public async Task RegisterByEmailShouldFailWhenEmailIdIsInvalidAsync()
    {
        ...
        var result = await AxisIdentitiesMediator(scope).RegisterByEmailAsync(command);
