...
public class AxisResultFunctionalValueTaskTests
{
    ...
    {
        var r = await AxisResult.AxisResult.Ok().MapAsync(() => VTAsync(10));
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).MapAsync(x => VTAsync(x * 2));
        Assert.Equal(10, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).MapAsync(x => VTAsync(x * 2));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok().ThenAsync(() => VTOkAsync());
    ...
    {
        var r = await AxisResult.AxisResult.Ok().ThenAsync(() => VTOkAsync(8));
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ThenAsync(_ => VTOkAsync());
        Assert.True(r.IsSuccess);
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ThenAsync(_ => VTErrAsync(E1));
        Assert.True(r.IsFailure);
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ThenAsync(x => VTOkAsync(x.ToString()));
        Assert.Equal("5", r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).ThenAsync(x => VTOkAsync(x.ToString()));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Ok().TapAsync(() => { called = true; return ValueTask.CompletedTask; });
        Assert.True(called);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Error(E1).TapAsync(() => { called = true; return ValueTask.CompletedTask; });
        Assert.False(called);
    }
    ...
    {
        var called = false;
        var r = await AxisResult.AxisResult.Ok(5).TapAsync(() => { called = true; return ValueTask.CompletedTask; });
        Assert.True(called);
        Assert.Equal(5, r.Value);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Error<int>(E1).TapAsync(() => { called = true; return ValueTask.CompletedTask; });
        Assert.False(called);
    }
    ...
    {
        var captured = 0;
        await AxisResult.AxisResult.Ok(9).TapAsync(x => { captured = x; return ValueTask.CompletedTask; });
    ...
    {
        var captured = 0;
        await AxisResult.AxisResult.Error<int>(E1).TapAsync(x => { captured = x; return ValueTask.CompletedTask; });
    ...
    {
        var captured = 0;
        await AxisResult.AxisResult.Error(E1).TapErrorAsync(errs => { captured = errs.Count; return ValueTask.CompletedTask; });
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Ok().TapErrorAsync(_ => { called = true; return ValueTask.CompletedTask; });
        Assert.False(called);
    }
    ...
    {
        var captured = 0;
        await AxisResult.AxisResult.Error<int>(E1).TapErrorAsync(errs => { captured = errs.Count; return ValueTask.CompletedTask; });
        Assert.Equal(1, captured);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Ok(1).TapErrorAsync(_ => { called = true; return ValueTask.CompletedTask; });
        Assert.False(called);
    }
    ...
    {
        var s = await AxisResult.AxisResult.Ok().MatchAsync(() => VTAsync("ok"), _ => VTAsync("no"));
        Assert.Equal("ok", s);
    }
    ...
    {
        var s = await AxisResult.AxisResult.Error(E1).MatchAsync(() => VTAsync("ok"), errs => VTAsync($"c{errs.Count}"));
        Assert.Equal("c1", s);
    }
    ...
    {
        var s = await AxisResult.AxisResult.Ok(10).MatchAsync(v => VTAsync(v.ToString()), _ => VTAsync("x"));
        Assert.Equal("10", s);
    }
    ...
    {
        var s = await AxisResult.AxisResult.Error<int>(E1).MatchAsync(v => VTAsync(v.ToString()), _ => VTAsync("fail"));
        Assert.Equal("fail", s);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error(E1).OrElseAsync(_ => VTOkAsync());
        Assert.True(r.IsSuccess);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error(E1).OrElseAsync(_ => VTErrAsync(E2), combineErrors: true);
    ...
    {
        var r = await AxisResult.AxisResult.Error(E1).OrElseAsync(_ => VTOkAsync(), combineErrors: true);
        Assert.True(r.IsSuccess);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error(E1).OrElseAsync(_ => VTErrAsync(E2), combineErrors: false);
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).OrElseAsync(_ => VTOkAsync(99));
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).OrElseAsync(_ => VTErrAsync<int>(E2), combineErrors: true);
        Assert.Equal(2, r.Errors.Count);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).OrElseAsync(_ => VTOkAsync(7), combineErrors: true);
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).OrElseAsync(_ => VTErrAsync<int>(E2), combineErrors: false);
        Assert.Single(r.Errors);
        Assert.Equal("E2", r.Errors[0].Code);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(10).EnsureAsync(x => VTAsync(x > 0), E1);
        Assert.True(r.IsSuccess);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(-1).EnsureAsync(x => VTAsync(x > 0), E1);
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E2).EnsureAsync(x => VTAsync(x > 0), E1);
        Assert.Equal("E2", r.Errors[0].Code);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(10).EnsureAsync(_ => VTOkAsync());
        Assert.True(r.IsSuccess);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(10).EnsureAsync(_ => VTErrAsync(E1));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Error<int>(E2).EnsureAsync(_ => { called = true; return VTOkAsync(); });
        Assert.False(called);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ZipAsync(x => VTAsync(x * 2));
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).ZipAsync(x => VTAsync(x * 2));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ZipAsync(x => VTOkAsync(x + 1));
    ...
    {
        var r = await AxisResult.AxisResult.Ok(5).ZipAsync(_ => VTErrAsync<int>(E1));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var called = false;
        await AxisResult.AxisResult.Error<int>(E1).ZipAsync(x => { called = true; return VTOkAsync(x); });
        Assert.False(called);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverAsync(errs => VTAsync(errs.Count * 10));
        Assert.Equal(10, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverAsync(() => VTAsync(42));
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync(errs => errs.Count == 1, _ => VTAsync(99));
        Assert.Equal(99, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync(errs => errs.Count > 5, _ => VTAsync(99));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync(AxisErrorType.NotFound, () => VTAsync(99));
        Assert.Equal(99, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync(AxisErrorType.Conflict, () => VTAsync(99));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync("E1", () => VTAsync(99));
        Assert.Equal(99, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(E1).RecoverWhenAsync("X", () => VTAsync(99));
        Assert.True(r.IsFailure);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(new[] { E1, AxisError.NotFound("X") }).RecoverNotFoundAsync(() => VTAsync(42));
        Assert.Equal(42, r.Value);
    }
    ...
    {
        var r = await AxisResult.AxisResult.Error<int>(new[] { E1, E2 }).RecoverNotFoundAsync(() => VTAsync(42));
        Assert.True(r.IsFailure);
    }
