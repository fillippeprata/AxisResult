...
{
    public async Task<AxisResult.AxisResult> PublishAsync<TEvent>(TEvent @event, params string[] topics) where TEvent : IAxisEvent
    {
        ...
        return AxisResult.AxisResult.Combine(results);
    }
}
